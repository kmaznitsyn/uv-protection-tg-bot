TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "uv_day_header": "☀️ *UV Protection Today — Full Day Forecast*",
        "uv_day_apply": "Sunscreen required at the following times today:\n",
    ...
    "de": {
        ...
        "uv_day_header": "☀️ *UV-Schutz heute — Ganztages-Prognose*",
        "uv_day_apply": "Heute UV-Schutz-Creme zu folgenden Zeiten notwendig:\n",
    ...
    "uk": {
        ...
        "uv_day_header": "☀️ *UV-захист сьогодні — Прогноз на весь день*",
        "uv_day_apply": "Сонцезахисний крем потрібен сьогодні у такі години:\n",
    ...
    "fr": {
        ...
        "uv_day_header": "☀️ *Protection UV aujourd'hui — Prévisions complètes*",
        "uv_day_apply": "Crème solaire requise aux heures suivantes aujourd'hui:\n",
    ...
    "es": {
        ...
        "uv_day_header": "☀️ *Protección UV hoy — Previsión completa*",
        "uv_day_apply": "Protector solar necesario a las siguientes horas hoy:\n",
    ...
    "pl": {
        ...
        "uv_day_header": "☀️ *Ochrona UV dzisiaj — Prognoza całodniowa*",
        "uv_day_apply": "Krem z filtrem wymagany dzisiaj o następujących porach:\n",
    ...
    "it": {
        ...
        "uv_day_header": "☀️ *Protezione UV oggi — Previsione completa*",
        "uv_day_apply": "Crema solare necessaria oggi nei seguenti orari:\n",
